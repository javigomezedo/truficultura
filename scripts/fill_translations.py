...
EN = {
    ...
    # Onboarding IA — quota & help-request
    "Asistente IA": "AI assistant",
    "Cuota mensual:": "Monthly quota:",
    "sesiones usadas este mes": "sessions used this month",
    "Has agotado la cuota. Actualiza a Enterprise para sesiones ilimitadas.": "You have used up your quota. Upgrade to Enterprise for unlimited sessions.",
    "Has alcanzado el límite de {limit} sesiones de onboarding este mes para el plan {plan}. Actualiza para más capacidad.": "You have reached the limit of {limit} onboarding sessions this month for the {plan} plan. Upgrade for more capacity.",
    "Solicitar ayuda con esta importación": "Request help with this import",
    "Ayuda solicitada": "Help requested",
    "Enviando…": "Sending…",
    "Hemos recibido tu petición de ayuda.": "We have received your help request.",
    "Te contactaremos pronto por email para ayudarte con esta importación.": "We will contact you soon by email to help with this import.",
    "Solicitada el": "Requested on",
    "Esta sesión lleva varios días sin avanzar.": "This session has been stalled for several days.",
    "Onboarding con IA (importar Excel históricos)": "AI-powered onboarding (import historical Excel files)",
    "Onboarding con IA: 5 importaciones/mes": "AI-powered onboarding: 5 imports/month",
    "Onboarding con IA ilimitado": "Unlimited AI-powered onboarding",
    "Onboarding con IA": "AI-powered onboarding",
    "Sube tus hojas de Excel hist\u00f3ricas (gastos, ingresos, parcelas) y deja que el agente IA detecte la entidad, proponga el mapeo de columnas y transforme los datos al formato de Trufiq. T\u00fa revisas y confirmas.": "Upload your historical Excel sheets (expenses, incomes, plots) and let the AI agent detect the entity, suggest the column mapping and transform the data into Trufiq's format. You review and confirm.",
    "Sesiones de onboarding": "Onboarding sessions",
    "Histórico de sesiones del asistente IA en todos los tenants. Vista de sólo lectura.": "History of AI assistant sessions across all tenants. Read-only view.",
    "Todos": "All",
    "sesión(es)": "session(s)",
    "Tenant": "Tenant",
    "Plan": "Plan",
    ...
    "Creada": "Created",
    "Actualizada": "Updated",
    "No hay sesiones que coincidan con los filtros.": "No sessions match the filters.",
    "Administración": "Administration",
}
...
FR = {
    ...
    "Cuota mensual:": "Quota mensuel :",
    "sesiones usadas este mes": "sessions utilisées ce mois-ci",
    "Has agotado la cuota. Actualiza a Enterprise para sesiones ilimitadas.": "Vous avez épuisé votre quota. Passez à Enterprise pour des sessions illimitées.",
    "Has alcanzado el límite de {limit} sesiones de onboarding este mes para el plan {plan}. Actualiza para más capacidad.": "Vous avez atteint la limite de {limit} sessions d'onboarding ce mois-ci pour le plan {plan}. Passez à un plan supérieur pour plus de capacité.",
    "Solicitar ayuda con esta importación": "Demander de l'aide pour cet import",
    "Ayuda solicitada": "Aide demandée",
    "Enviando…": "Envoi…",
    "Hemos recibido tu petición de ayuda.": "Nous avons bien reçu votre demande d'aide.",
    "Te contactaremos pronto por email para ayudarte con esta importación.": "Nous vous contacterons bientôt par e-mail pour vous aider avec cet import.",
    "Solicitada el": "Demandée le",
    "Esta sesión lleva varios días sin avanzar.": "Cette session est bloquée depuis plusieurs jours.",
    "Onboarding con IA (importar Excel históricos)": "Onboarding avec IA (importer les Excel historiques)",
    "Onboarding con IA: 5 importaciones/mes": "Onboarding avec IA : 5 imports/mois",
    "Onboarding con IA ilimitado": "Onboarding avec IA illimité",
    "Onboarding con IA": "Onboarding avec IA",
    "Sube tus hojas de Excel hist\u00f3ricas (gastos, ingresos, parcelas) y deja que el agente IA detecte la entidad, proponga el mapeo de columnas y transforme los datos al formato de Trufiq. T\u00fa revisas y confirmas.": "Téléversez vos feuilles Excel historiques (dépenses, revenus, parcelles) et laissez l'agent IA détecter l'entité, proposer le mappage des colonnes et transformer les données au format Trufiq. Vous vérifiez et confirmez.",
    "Sesiones de onboarding": "Sessions d'onboarding",
    "Histórico de sesiones del asistente IA en todos los tenants. Vista de sólo lectura.": "Historique des sessions de l'assistant IA pour tous les tenants. Vue en lecture seule.",
    "Todos": "Tous",
    "sesión(es)": "session(s)",
    "Tenant": "Tenant",
    "Plan": "Plan",
    ...
    "No hay sesiones que coincidan con los filtros.": "Aucune session ne correspond aux filtres.",
    "Administración": "Administration",
}
